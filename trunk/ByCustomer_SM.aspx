...
<body>
    ...
    <asp:Label ID="lblSelectAccount" runat="server" Text="Selected Account :" 
    ...
    <asp:Label ID="lblAddNewStatus" runat="server" Text="Add New Status" 
                    style="font-weight: 700; color: #0000CC; text-decoration: underline"></asp:Label>          
            </td>
            <td align="left">          
     <asp:Label ID="lblHistoryStatus" runat="server" style="color: #0000CC; font-weight: 700; text-decoration: underline;" 
     Text="History account Status (ประวัติสถานะบัญชีที่เลือก สถานะล่าสุดอยู่บนสุด)"></asp:Label>          
            </td>
        </tr>
        <tr>
        <td valign="top">
        ...
        <tr>
            <td valign="top" colspan="2">
                ...
                DataValueField="Id_Status" onchange="showHideDivDatePromise(this,ele('divDatePromise'),event);">
                </asp:DropDownList>
...
<div id="divDatePromise" style="white-space:nowrap;visibility:hidden;">
                    ...
                    <cc1:CalendarExtender ID="calDatePromise"
                        runat="server" PopupButtonID="imbDatePromise" 
                        TargetControlID="txtDatePromise" Format="dd/MM/yyyy">
        ...
        <tr>
            <td valign="top" class="style4">
                Comment</td>
            <td valign="top">
               <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Height="79px" 
        ...
        <tr>
            <td valign="top" class="style1">
                <asp:Button ID="btAddStatus" runat="server" Text="Add Status" 
                    OnClientClick="return chkDataInput();"/>
            </td>
            <td valign="top" class="style1">
                </td>
        ...
        <td valign="top">
        <asp:GridView ID="gvAccount_Status" runat="server" AutoGenerateColumns="False" 
        BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" 
        CellPadding="3" DataSourceID="SqlDataAccount_Status" 
        GridLines="Horizontal" AllowPaging="True" AllowSorting="True">
        <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
